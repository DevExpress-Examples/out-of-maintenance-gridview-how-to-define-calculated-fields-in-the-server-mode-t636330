...
Namespace CalculatedFieldsInServerMode.Models
	...
	Partial Public Class CalculatedFieldsTestEntities
		...
		Public Overridable Function CustomProducts(ByVal daysExpiresOffset? As Integer, ByVal currentDate? As Date) As IQueryable(Of CustomProducts_Result)
			...
			Dim currentDateParameter = If(currentDate.HasValue, New ObjectParameter("currentDate", currentDate), New ObjectParameter("currentDate", GetType(Date)))
